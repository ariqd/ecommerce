...
<nav id="header" class="w-full z-30 top-0 py-1">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-4">
        ...
        <div class="order-1 md:order-2">
            <a class="flex items-center tracking-widest no-underline hover:no-underline font-bold text-gray-800 text-xl " href="{{ url('/') }}">
                ATALLA
            </a>
        </div>
        ...
        <div class="order-2 md:order-3 flex items-center" id="nav-content">
            ...
            <a class="pr-3 inline-block no-underline hover:text-black" href="#">
            ...
            @if (Route::has('login'))
                @auth
                    @if (auth()->user()->role == App\Models\User::CUSTOMER)
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a class="inline-block no-underline hover:text-black hover:underline py-2 px-3" href="{{ route('register') }}">Daftar</a>
                    @endif
                @endif
            @endif            
